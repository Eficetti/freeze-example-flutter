...
class _$JobTearOff {
  ...
  _Job call({String name = 'Software Enginer', required int level}) {
    return _Job(
      name: name,
      level: level,
    );
...
class _$_Job with DiagnosticableTreeMixin implements _Job {
  const _$_Job({this.name = 'Software Enginer', required this.level});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Job(name: $name, level: $level)';
  }
...
abstract class _Job implements Job {
  const factory _Job({String name, required int level}) = _$_Job;
